          ...
          return (
            ...
            >
              ...
              <button
                ...
                className={`relative w-11 h-6 rounded-full transition-colors p-0.5 cursor-pointer focus-visible:ring-2 focus-visible:ring-purple-400 focus-visible:outline-none ${
