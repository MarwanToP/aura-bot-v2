...
export default function ToggleSwitch({ enabled, onToggle, disabled = false, ariaLabel = "Toggle switch" }) {
  return (
    <button
      ...
      className={`w-12 h-6 flex items-center rounded-full p-1 transition-colors cursor-pointer disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-purple-500 focus:outline-none ${
