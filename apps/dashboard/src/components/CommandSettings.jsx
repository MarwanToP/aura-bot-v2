          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            ...
            >
              <div className="flex items-center justify-between border-b border-[#1e2333] pb-3">
                ...
                <button type="button" aria-label="Close restrictions modal" onClick={() => setSelectedCmd(null)} className="text-zinc-400 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 rounded-md">
                  <X className="w-4 h-4" />
                </button>
              </div>
                ...
                {["@Administrator", "@Moderator", "@VIP Supporter", "@Everyone"].map((role) => {
                  ...
                  return (
                    <button
                      ...
                      className="flex items-center justify-between w-full p-3 rounded-xl bg-[#0b0d14] border border-[#1e2333] text-xs font-medium cursor-pointer hover:border-purple-500/40 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500"
                    >
