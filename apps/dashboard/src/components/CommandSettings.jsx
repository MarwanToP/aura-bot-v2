                ...
                {["@Administrator", "@Moderator", "@VIP Supporter", "@Everyone"].map((role) => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full flex items-center justify-between p-3 rounded-xl bg-[#0b0d14] border border-[#1e2333] text-xs font-medium cursor-pointer hover:border-purple-500/40 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500"
                    >
