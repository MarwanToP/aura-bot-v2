            ...
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <button
                  ...
                  className={`w-11 h-6 rounded-full p-1 transition-colors flex items-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-purple-500/40 ${
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            ...
            >
              <div className="flex items-center justify-between border-b border-[#1e2333] pb-3">
                ...
                <button aria-label="Close permissions modal" onClick={() => setSelectedCmd(null)} className="text-zinc-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-purple-500/40 rounded-sm">
                  <X className="w-4 h-4" />
                </button>
              </div>
