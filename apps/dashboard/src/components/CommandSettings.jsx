            ...
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <button
                  ...
                  className={`w-11 h-6 rounded-full p-1 transition-colors flex items-center cursor-pointer focus-visible:ring-2 focus-visible:ring-purple-500 ${
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            ...
            >
              <div className="flex items-center justify-between border-b border-[#1e2333] pb-3">
                ...
                <button type="button" aria-label="Close modal" onClick={() => setSelectedCmd(null)} className="text-zinc-400 hover:text-white focus-visible:ring-2 focus-visible:ring-purple-500 rounded-md">
                  <X className="w-4 h-4" />
                </button>
              </div>
                ...
                {["@Administrator", "@Moderator", "@VIP Supporter", "@Everyone"].map((role) => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full flex items-center justify-between p-3 rounded-xl bg-[#0b0d14] border border-[#1e2333] text-xs font-medium cursor-pointer hover:border-purple-500/40 transition-colors focus-visible:ring-2 focus-visible:ring-purple-500"
                    >
